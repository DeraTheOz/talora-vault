/* app/components/forms/custom-select.tsx */
/* Shared native select with a custom chevron icon and optional wrapper spacing. */
...
//         defaultValue={defaultValue}
//         aria-label={ariaLabel}
//         className="select w-full rounded-lg border border-talora-dark-blue bg-talora-dark-blue py-3 pl-4 pr-12 text-sm text-talora-white outline-none transition focus:border-talora-red cursor-pointer">
//         {options.map((option) => (
//           <option key={option.value || "empty"} value={option.value}>
//             {option.label}
//           </option>
