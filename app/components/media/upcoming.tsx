...
import { useUpcoming } from "@/features/upcoming/hooks/use-upcoming";
...
export default function Upcoming({ id }: UpcomingProps) {
    ...
    <section
      ...
      <div className="flex flex-wrap items-center gap-3 md:gap-4">
        ...
        <TabToggle
          ...
          ariaLabel={t("upcomingFilterAria")}
        />
      </div>
